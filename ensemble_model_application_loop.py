"""Applies saved winner-takes-all specialist map to all 13 datasets and computes mass outputs.
Runs automatically from a config list — no manual filename updates needed.
"""
...
# model_files for all entries point directly to the CSV outputs from the
# synth inference script — no parent/slicing logic needed since facility
# CSVs are already generated by that script.
# =============================================================================
DATASET_CONFIGS = [
    # --- 3 CITY-LEVEL (FULL SEWERSHEDS) ---
    {
    ...
    },
    {
        ...
        "pop_size": 2890,  # UPDATE
        "pop_ww_volume": pop_ww_volume_sandwich,
    },

    # --- 10 FACILITY-LEVEL SUBSETS ---
    # These point directly to the facility CSVs generated by the synth script.
    # No parent/slicing needed here.
    {
        "name": "clark_county_nv_campus",
        "demo_rx": "clark_county_nv_demo_rx.csv",  # parent raw data used for merge
        "model_files": {
...
def run_ensemble(config):
    ...
    # Note: Dropping the 'Pharmaceutical' string reference column from the merge
