...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Linear SVM baseline for PharmShed subgroup training.")
    ...
    parser.add_argument("--run-name", type=str, default="new_svm_subgroup")
...
def main() -> None:
    ...
    print("note: LinearSVC defaults to a sampled subgroup-sized run because full-scale training is impractical.")
