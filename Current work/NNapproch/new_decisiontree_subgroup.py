...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Decision Tree baseline for PharmShed subgroup or full-label training.")
    ...
    parser.add_argument("--run-name", type=str, default="new_decisiontree_subgroup")
